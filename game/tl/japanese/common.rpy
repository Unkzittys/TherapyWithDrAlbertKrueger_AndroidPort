...
translate japanese strings:
    ...
    old "Font Override"
    new "{font=PixelMplus10-Regular.ttf}フォントオーバーライド{/font}"


    old "Default"
    new "{font=PixelMplus10-Regular.ttf}デフォルト{/font}"
    ...
    new "{font=PixelMplus10-Regular.ttf}テキストサイズのスケーリング{/font}"


    old "Reset"
    new "{font=PixelMplus10-Regular.ttf}リセット{/font}"


    old "Line Spacing Scaling"
    new "{font=PixelMplus10-Regular.ttf}行間のスケーリング{/font}"


    old "Self-Voicing"
    new "{font=PixelMplus10-Regular.ttf}セルフボイシング{/font}"


    old "Off"
    new "{font=PixelMplus10-Regular.ttf}オフ{/font}"
    ...
    new "{font=PixelMplus10-Regular.ttf}{size=+5}このメニューのオプションは、アクセシビリティを改善するためのものです。すべてのゲームで動作するわけではなく、特定の組合せではゲームを正常にレンダリングしないでしょう。これはゲームやエンジンの問題ではありません。フォントを変更時に最良の結果を得るには、テキストサイズを元のサイズと同じに保つようにしてください。{/size}{/font}"
    ...
    new "{font=PixelMplus10-Regular.ttf}クリップボードボイシングを有効化しました。'shift+a'で無効化します{/font}"


    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "{font=PixelMplus10-Regular.ttf}セルフボイシングは次のように話します。 \"[renpy.display.tts.last]\". 'shift+a' で無効化します{/font}"


    old "Self-voicing enabled. Press 'v' to disable."
    new "{font=PixelMplus10-Regular.ttf}セルフボイシングを有効化しました。'shift+a' で無効化します{/font}"
