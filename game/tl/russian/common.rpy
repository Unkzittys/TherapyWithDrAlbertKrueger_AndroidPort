...
translate russian strings:
    ...
    new "Озвучивание выключено."


    old "Clipboard voicing enabled. "
    new "Буферизация включена. "
    ...
    new "Опции этого меню предназначены для улучшения доступности. Они могут не работать со всеми играми, и некоторые сочетания опций могут сделать игру неиграбельной. Это не проблема игры или движка. Ради лучшего результата советуется не изменять оригинальный размер текста."
    ...
    new "Все несохраненные данные будут потеряны. \nВы уверены, что хотите сделать это?"
    ...
    new "Вы уверены, что хотите вернутся в главное меню?\nВсе несохраненные данные будут потеряны."


    old "Are you sure you want to end the replay?"
    new "Вы уверены, что хотите закончить реплей?"


    old "Are you sure you want to begin skipping?"
    new "Вы уверены, что хотите пропустить?"
    ...
    new "Вы уверены, что хотите пропустить диалог до следующего выбора?"
    ...
    new "Буферизация включена. Нажмите 'shift+a', чтобы выключить."


    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "Озвучивание текста произнесёт \"[renpy.display.tts.last]\". Нажмите 'shift+a', чтобы выключить."


    old "Self-voicing enabled. Press 'v' to disable."
    new "Озвучивание текста включено. Нажмите 'shift+a', чтобы выключить."
