...
translate portuguese strings:
    ...
    new "Voz própria desativada."


    old "Clipboard voicing enabled. "
    new "Voicing da área de transferência habilitado. "


    old "Self-voicing enabled. "
    new "Voz própria habilitada. "
    ...
    new "As opções neste menu têm como objetivo melhorar a acessibilidade. Eles podem não funcionar com todos os jogos e algumas combinações de opções podem tornar o jogo impossível de jogar. Este não é um problema com o jogo ou motor. Para obter os melhores resultados ao alterar as fontes, tente manter o tamanho do texto igual ao original."
    ...
    new "Você tem certeza que quer voltar ao menu principal? \nIsso vai perder progresso não salvo."
    ...
    new "Voz da área de transferência ativada. Pressione 'shift+a' para desativar."


    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "A voz própria diria \"[renpy.display.tts.last]\". Pressione 'shift+a' para desativar."


    old "Self-voicing enabled. Press 'v' to disable."
    new "Voz própria ativada. Pressione 'shift+a' para desativar."
