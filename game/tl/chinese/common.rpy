...
translate chinese strings:
    ...
    old "Font Override"
    new "{font=pixel.ttf}重设字体{/font}"


    old "Default"
    new "{font=pixel.ttf}默认{/font}"
    ...
    new "{font=pixel.ttf}字体大小{/font}"


    old "Reset"
    new "{font=pixel.ttf}重置{/font}"


    old "Line Spacing Scaling"
    new "{font=pixel.ttf}间距大小{/font}"


    old "Self-Voicing"
    new "{font=pixel.ttf}自动朗读{/font}"


    old "Off"
    new "{font=pixel.ttf}关闭{/font}"


    old "Text-to-speech"
    new "{font=pixel.ttf}文字语言转换{/font}"


    old "Clipboard"
    new "{font=pixel.ttf}剪贴板{/font}"


    old "Debug"
    new "{font=pixel.ttf}Debug{/font}"


    old "The options on this menu are intended to improve accessibility. They may not work with all games, and some combinations of options may render the game unplayable. This is not an issue with the game or engine. For the best results when changing fonts, try to keep the text size the same as it originally was."
    new "{font=pixel.ttf}{size=+5}此菜单上的选项旨在改善辅助功能。它们可能不适用于所有游戏，并且某些选项组合可能会使游戏无法玩。这不是游戏或引擎的问题。为了在更改字体时获得最佳效果，请尝试使文本大小与原始大小相同。{/size}{/font}"
    ...
    new "{font=pixel.ttf}剪贴板朗读已开启。 如需取消，请按'shift+a'。{/font}"


    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "{font=pixel.ttf}自我朗读会说 \"[renpy.display.tts.last]\"。 如需取消，请按'shift+a'。{/font}"


    old "Self-voicing enabled. Press 'v' to disable."
    new "{font=pixel.ttf}自我朗读已开启。如需取消，请按'shift+a'。{/font}"
